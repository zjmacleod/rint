...
pub(crate) struct GaussKronrod61;

impl Integrate for GaussKronrod61 {
    type Shared = [SharedData; 15];
    type Extended = [ExtendedData; 15];
...
static SHARED_DATA: [SharedData; 15] = [
    SharedData::new(
...
static EXTENDED_DATA: [ExtendedData; 15] = [
    ExtendedData::new(
