...
pub(crate) struct GaussKronrod21;

impl Integrate for GaussKronrod21 {
    type Shared = [SharedData; 5];
    type Extended = [ExtendedData; 5];
...
static SHARED_DATA: [SharedData; 5] = [
    SharedData::new(
...
static EXTENDED_DATA: [ExtendedData; 5] = [
    ExtendedData::new(
